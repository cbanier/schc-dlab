...
# Install Python dependencies for common SCHC requirements
COPY ./requirements.txt /root/requirements.txt
RUN pip install -r requirements.txt

# Set Python path for the projects
ENV PYTHONPATH=/root/schc-implementations/openschc/src/:/root/schc-implementations/cruschc/p2p-integration/

# Create directories for GUI config
RUN mkdir -p /root/.coregui/xmls /root/.coregui/backgrounds
